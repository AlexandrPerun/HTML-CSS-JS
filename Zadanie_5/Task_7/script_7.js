function convertToRoman(n) {
	var arabic_num = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1000];
	var roman_num = ["I", "IV", "V", "IX", "X", "XL", "L", "XC", "C", "CD", "D", "CD", "M"]; 
	var number = "";

	for(var i = arabic_num.length - 1; i >=0; i--) {
    	while(arabic_num[i] <= n) {
      		number += roman_num[i];
      		n -= arabic_num[i];
    	}
  	}
